<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.categoryName" placeholder="商品类别" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column label="类别名称" min-width="150px">
        <template slot-scope="{row}">
...
<script>
import { fetchList, createCategory, updateCategory, hiddenCategory } from '@/api/category'
